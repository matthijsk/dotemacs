...
#+begin_src emacs-lisp
  (use-package gptel
    ...
    (gptel-make-preset 'python-django
      ...
      :system "You are a Python programmer and a Django expert.
  Respond concisely. Never apologize.
  Cite sources with your answers if possible. Replace version numbers in links to docs.djangoproject.com with \"stable\".")
