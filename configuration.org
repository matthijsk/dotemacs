...
#+BEGIN_SRC emacs-lisp
  (eval-after-load 'info
    '(progn
       (define-key Info-mode-map (kbd my-mouse-back-event) 'Info-history-back)
       (define-key Info-mode-map (kbd my-mouse-forward-event) 'Info-history-forward)))

  (eval-after-load 'help
    '(progn
       (define-key help-mode-map (kbd my-mouse-back-event) 'help-go-back)
       (define-key help-mode-map (kbd my-mouse-forward-event) 'help-go-forward)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "M-s o") 'my-occur)
#+END_SRC
