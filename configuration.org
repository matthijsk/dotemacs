...
#+BEGIN_SRC emacs-lisp
  (use-package bat-mode
    ...
    :config
    (defun my-bat-cmd-help ()
      (interactive)
      (bat-cmd-help (word-at-point))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  See also `helm-grep-ag-command'. (We use ripgrep)"
    ...
    ;; Set up defalias for helm-projectile-find-other-file to
    ;; projectile-find-other-file. The update to projectile-2.1.0 broke
    ;; helm-projectile-find-other-file. Workaround until helm-projectile is
    ;; updated.
    (defalias #'helm-projectile-find-other-file #'projectile-find-other-file))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    (setq company-backends '(company-keywords company-capf))
      ...
      (if git-exe
          (progn
            ...
            (use-package epg
              :defer t
              :init
              (setq epg-gpg-program (concat git-path "/gpg"))))
