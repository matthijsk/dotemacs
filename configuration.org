...
#+BEGIN_SRC emacs-lisp
  (use-package consult
    ...
    ;; TODO: Can probably be achieved using `consult-after-jump-hook'.
    (advice-add 'consult-org-heading
                :after
                (lambda ()
                  "Move selected line to top when consult-org-heading exits."
...
#+begin_src emacs-lisp
  (use-package projectile
    ...
    (setq consult-project-function #'projectile-acquire-root)

    (defun my-projectile-consult-ripgrep ()
      (interactive)
      (consult-ripgrep (projectile-acquire-root) (symbol-name (symbol-at-point))))
