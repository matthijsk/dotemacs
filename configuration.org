...
Enable ~repeat-mode~, a new feature in Emacs 28. How could I have lived without
this?
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  the default value is used."
    ...
    (defun my-org-daily-standup ()
      "Clock in for daily stand-up and clock table and agenda.
...
#+BEGIN_SRC emacs-lisp
  (use-package elfeed
    ...
    ;; Tag news entries older than one day as read.
