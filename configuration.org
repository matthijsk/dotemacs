...
#+BEGIN_SRC emacs-lisp
  (use-package helm
    ...
    (advice-add 'semantic-go-to-tag
                :after
                (lambda (candidate &optional persistent)
                  "Move selected line to top after selecting a semantic tag."
                  (recenter-top-bottom 0))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  demoted by one level."
    ...
    (setq org-clock-clocktable-default-properties
          '(:maxlevel 2 :scope agenda :block yesterday :narrow 120!))
